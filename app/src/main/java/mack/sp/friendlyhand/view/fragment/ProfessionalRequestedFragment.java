...
public class ProfessionalRequestedFragment extends ListFragment {
    public final static String urlServicosSolicitados = "http://" + IP + "/friendlyhand/v1/prestador/";
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent.putExtra("acao", "confirmar");
    ...
    public class BuscarServicosSolicitados extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (prestador != null) {
                Log.e("SERVICOS", prestador.getServicos().size() + "");
                if (prestador.getServicosContratados().size() > 0 && !prestador.getServicosContratados().isEmpty()) {
                    adapter = new ContractedServiceAdapter(getActivity(), prestador.getServicosContratados());
