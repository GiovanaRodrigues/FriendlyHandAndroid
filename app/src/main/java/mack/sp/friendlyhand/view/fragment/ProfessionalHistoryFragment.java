...
import mack.sp.friendlyhand.adapter.HistoryAdapter;
...
import mack.sp.friendlyhand.view.activity.EvaluationActivity;
...
public class ProfessionalHistoryFragment extends ListFragment {
    public final static String urlServicosConcluidos = "http://" + IP + "/friendlyhand/v1/servicoscontratados/";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        actionBar.setTitle(getResources().getString(R.string.historico));

        linearVazio = (LinearLayout) view.findViewById(R.id.layout_vazio);
    ...
    public class BuscarHistorico extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                retorno = RestUtil.get(urlServicosConcluidos + "Prestador/" + id + "?referencia=concluido", getActivity());
        ...
        protected void onPostExecute(String s) {
            ...
            if(servicos != null) {
                if (servicos.size() > 0 && !servicos.isEmpty()) {
                    adapter = new HistoryAdapter(getActivity(), servicos);
                    adapter.notifyDataSetChanged();

                    getListView().setAdapter(adapter);

                    linearVazio.setVisibility(View.GONE);
