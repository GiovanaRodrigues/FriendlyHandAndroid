...
import mack.sp.friendlyhand.view.activity.ClientRequestedActivity;
...
public class ClientRequestedFragment extends ListFragment {
    public final static String urlServicosSolicitados = "http://" + IP + "/friendlyhand/v1/cliente/";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        actionBar.setTitle(getResources().getString(R.string.servicos_solicitados));
    ...
    public void onStart() {
        ...
        new BuscarServicosSolicitados().execute();
    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent intent = new Intent(getActivity(), ClientRequestedActivity.class);
    ...
    public class BuscarServicosSolicitados extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                retorno = RestUtil.get(urlServicosSolicitados + id, getActivity());
        ...
        protected void onPostExecute(String s) {
            ...
            if (cliente != null) {
                Log.e("SERVICOS", cliente.getServicosContratados().size() + "");
                if (cliente.getServicosContratados().size() > 0) {
                    adapter = new ContractedServiceAdapter(getActivity(), cliente.getServicosContratados());
