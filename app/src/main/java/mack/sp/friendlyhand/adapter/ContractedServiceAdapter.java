...
public class ContractedServiceAdapter extends BaseAdapter {
    ...
    public ContractedServiceAdapter(Context contexto, List<ServicoContratado> servicos) {
    ...
    public class BuscarServicos extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (prestador != null) {
                if (prestador.getServicos().size() > 0 && !prestador.getServicos().isEmpty()) {
                    for (int i = 0; i < prestador.getServicos().size(); i++) {
                        ...
                        if (servicoAtual.getId() == servicoContratado.getId_servico()) {
                            Log.e("SERVICO", servicoContratado.toString() + " - " + servicoAtual.toString());
                            ...
                            // Mudar ícone
                            if (servicoAtual.getCategoriaServico() != null) {
                ...
                //View alertView = view.inflate(R.layout.alert_erro, 1);

                //final TextView txtMensagem = (TextView) alertView.findViewById(R.id.txtMensagem);
                //txtMensagem.setText(contexto.getResources().getString(R.string.erro_dados));
